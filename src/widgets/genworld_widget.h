...
enum GenerateLandscapeWidgets : WidgetID {
	...
	WID_GL_SNOW_LINE_HEIGHT_DOWN,       ///< Decrease snow line height.
	WID_GL_SNOW_LINE_HEIGHT_TEXT,       ///< Snow line height.
	WID_GL_SNOW_LINE_HEIGHT_UP,         ///< Increase snow line height.
